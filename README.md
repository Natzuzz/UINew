...
if CoreGui:FindFirstChild('Linoria_edit_by_nyaouu#2917') then
    CoreGui:FindFirstChild('Linoria_edit_by_nyaouu#2917'):Destroy()
end

local ScreenGui = Instance.new('ScreenGui');

ScreenGui.Name = 'Linoria_edit_by_nyaouu#2917'
